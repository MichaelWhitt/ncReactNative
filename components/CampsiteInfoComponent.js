                ...
                >
                    ...
                    <View style={styles.cardRow}>
                        ...
                        <Icon 
                            ...
                            raised
                            reverse
                            onPress={() => shareCampsite(campsite.name, campsite.description, baseUrl + campsite.img)}
                        />
                    </View>
                </Card>
            </Animatable.View>
            ...
            <ScrollView>
                ...
                >
                    <View style={styles.modal}>
                        ...
                        />
                        <View style={{margin: 10}}>
                            <Button color="#5637DD" onPress={()=> {this.toggleModal(); this.handleComment(campsiteId);}} title="Submit">Click Me</Button>
                        </View>
                        <View style={{margin: 10}}>
                            <Button color="#808080" onPress={()=> {this.toggleModal(); this.resetForm()}} title="Cancel">Click Me</Button>
                        </View>
